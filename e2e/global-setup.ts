...
async function seedFixture(databaseUrl: string): Promise<void> {
	...
	try {
		...
		for (const { id, document } of [
			...
			{ id: CHANGE_SUMMARY_ENABLED_REPORT_ID, document: CHANGE_SUMMARY_ENABLED_DOCUMENT },
			{ id: CHANGE_SUMMARY_DISABLED_REPORT_ID, document: CHANGE_SUMMARY_DISABLED_DOCUMENT },
			{ id: CHANGE_SUMMARY_FIRST_ISSUE_REPORT_ID, document: CHANGE_SUMMARY_FIRST_ISSUE_DOCUMENT }
		]) {
